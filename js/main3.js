...
function piechart_severity() {
  ...
  var explanation = "The record files include all types of accidents: The ones \
  with casualties, as well as fender benders. In total almost 82,000 accidents \
  took place in 2015. Unfortunately, the majority of 44% were associated with \
  casualties and 10% with severe injuries. We will focus on the fatal category \
...
debugger;
    ...
    var ssv = d3.dsv('\t', 'text/plain');
      //ssv("z_accident_full.tsv", function(d) {
...
function linechart2() {
  ...
  , a risen plateau can be seen for diseased pedestrians and bicyclist. You \
  can use the colored texts to switch corresponding categories on and off.";
  // explanatory text
  d3.select('chart.chart p').text(explanation)
